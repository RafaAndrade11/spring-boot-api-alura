...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var medico = cadastrarMedico("Rafael", "rafael@gmail.com", "111222", Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("Joao", "joao@gmail.com", "23312343234");
    ...
    void escolherMedicoAleatorioLivreNaDataCenario2() {
        ...
        cadastrarMedico("Rafael", "rafael@gmail.com", "111222", Especialidade.CARDIOLOGIA);

        var medicoLivre = medicoRepository.escolherMedicoAleatorioLivreNaData(Especialidade.CARDIOLOGIA, proximaSegundaAs10);
        assertThat(medicoLivre).isEqualTo(medicoLivre);
